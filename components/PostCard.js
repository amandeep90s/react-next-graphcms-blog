...
const PostCard = ({ post }) => {
  return (
    <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
      ...
      <h1 className="mb-8 text-3xl font-semibold text-center transition duration-700 cursor-pointer hover:text-green-400">
      ...
      <div className="items-center justify-center block w-full mb-8 text-center lg:flex">
        ...
        <div className="font-medium text-gray-700">
          <svg
            ...
            className="inline w-6 h-6 mr-2 text-green-500"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="inline-block px-8 py-3 text-lg font-medium text-white transition duration-500 transform bg-green-600 rounded-full cursor-pointer hover:-translate-y-1">
            Continue Reading
          </span>
        </Link>
      </div>
