...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === "LEFT" && (
      <div className="absolute py-3 text-center bg-green-600 rounded-full cursor-pointer arrow-btn bottom-5 left-4">
        <svg
    ...
    {position === "RIGHT" && (
      <div className="absolute py-3 text-center bg-green-600 rounded-full cursor-pointer arrow-btn bottom-5 right-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-full h-6 text-white"
          fill="none"
